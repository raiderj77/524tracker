---
title: "How Chase calculates 24 months: exact date math for open slots"
date: "2026-06-30"
slug: "how-chase-calculates-24-months-exact-date-math-for-open-slots"
description: "The short answer: Chase counts 24 calendar months backward from the date you apply. A card opened on June 15, 2023 falls off your count on June 15, 2025, not Ju"
status: published
author: "524Tracker"
---
...
Specifically, the cards that count are those that show up as new accounts on your personal credit report. [Chase's own reconsideration data points](https://www.reddit.com/r/churning/wiki/index#wiki_chase) and community-tracked approvals consistently show that the following count:
...
Pull your full credit report from [AnnualCreditReport.com](https://www.annualcreditreport.com) and look at the "date opened" field for every personal credit card account opened in the last 24 months.

Here is the process many people use:

1. List every personal card account with an open date in the last 24 months
2. Note the exact date opened for each
3. Count them. That is your current 5/24 number
4. For each card, the drop date is the same month and day, two years after the open date
5. Sort by drop date to see which card falls off soonest
...
Tools like [Credit Karma](https://www.creditkarma.com) or your card issuer's credit monitoring feature can show open dates, but always verify against your actual credit report. Discrepancies exist, and the bureau data is what Chase's system reads.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How does Chase calculate the 24 months for the 5/24 rule?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Chase counts exactly 24 calendar months back from your application date, not rolling 12-month periods. If you opened a card on March 15, 2023, it falls off your 5/24 count on April 1, 2025 \u2014 the first day of the month following the 24-month anniversary. Chase uses the month an account was opened, so the precise day matters less than the month and year reported on your credit report."
      }
    },
    {
      "@type": "Question",
      "name": "When exactly does a card drop off my 5/24 count?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A card drops off your 5/24 count on the first day of the month that is 25 months after the account opening month. For example, a card opened in January 2023 stops counting against you on February 1, 2025. This is because Chase looks at whether the open date falls within the past 24 complete months, making the 25th-month mark your true \"safe\" application window."
      }
    },
    {
      "@type": "Question",
      "name": "Does Chase count authorized user cards toward 5/24?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, authorized user accounts typically appear on your credit report and count toward your 5/24 total, though Chase sometimes overlooks them. If an authorized user card is pushing you over 5/24, you can ask the primary cardholder to remove you, then request a manual reconsideration with a Chase representative who can manually exclude it from the count during your application review."
      }
    },
    {
      "@type": "Question",
      "name": "How do I find out my current 5/24 status before applying?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pull your credit report from AnnualCreditReport.com and count every new card account opened in the past 24 months, including authorized user cards and store cards. Tools like 524tracker.com let you enter your card opening dates to automatically calculate your exact count and show you the precise date your oldest qualifying card will drop off, giving you a clear application timeline."
      }
    },
    {
      "@type": "Question",
      "name": "Can I apply for a Chase card the same day I hit under 5/24?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, you can apply on the exact day you drop below 5/24, which is the first of the month 25 months after your oldest qualifying card's opening month. Chase pulls your credit report in real time, so if that card no longer appears within the 24-month window at the moment of application, it will not count against you. Applying early in the morning on that date is generally safe."
      }
    }
  ]
}
